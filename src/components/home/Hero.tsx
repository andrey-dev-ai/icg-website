  ...
  return (
    ...
    >
      ...
      <div
        ...
        style={{
          width: 500, height: 500, top: "5%", left: "50%",
          transform: "translateX(-50%)",
          background: "radial-gradient(circle, rgba(212,185,120,0.1) 0%, transparent 70%)",
          filter: "blur(80px)",
        }}
      />
      <div
        className="absolute pointer-events-none rounded-full"
        style={{
          width: 350, height: 350, bottom: "15%", right: "10%",
      ...
      <motion.div
        ref={glowRef}
        initial={{ opacity: 0 }}
        animate={{ opacity: [0, 0.8, 0.5, 0.8], scale: [1, 1.05, 0.98, 1] }}
        transition={{ delay: heroTimeline.bgGlow.delay, duration: 8, repeat: Infinity, ease: "easeInOut" }}
        className="absolute pointer-events-none"
        style={{
          top: "-20%", left: "50%", transform: "translateX(-50%)",
          width: "120%", height: "70%",
          background: "radial-gradient(ellipse at center, rgba(164,136,74,0.1) 0%, rgba(15,22,41,0) 65%)",
        }}
      />
      ...
      <motion.div
        ...
        animate={{ opacity: 1, scale: 1 }}
        transition={{ delay: heroTimeline.divider.delay, duration: 1, ease: smoothEase }}
        className="flex items-center gap-3 mb-8 mt-4"
      >
        <motion.div
          initial={{ width: 0 }} animate={{ width: 48 }}
          transition={{ delay: heroTimeline.divider.delay + 0.2, duration: 0.8, ease: smoothEase }}
          className="h-px overflow-hidden"
          style={{ background: "linear-gradient(90deg, transparent, var(--gold-300))" }}
        />
        <div className="w-1.5 h-1.5 rotate-45 shrink-0" style={{ background: "var(--gold-300)", opacity: 0.6 }} />
        <motion.div
          initial={{ width: 0 }} animate={{ width: 48 }}
          transition={{ delay: heroTimeline.divider.delay + 0.2, duration: 0.8, ease: smoothEase }}
          className="h-px overflow-hidden"
      ...
      <MotionFadeUp delay={heroTimeline.divider.delay + 0.4} className="mb-12">
        <p
          ...
          style={{ fontSize: "clamp(1.1rem, 2.5vw, 1.6rem)", fontWeight: 400, color: "var(--text-secondary)", letterSpacing: "0.02em" }}
        >
          {t("slogan")}
        </p>
      </MotionFadeUp>
